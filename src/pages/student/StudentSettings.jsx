  ...
  return (
    ...
    >
      ...
      <section className={styles.layoutGrid}>
        <form className={styles.card} onSubmit={onProfileUpdate}>
          <h2 className={styles.cardTitle}>Profile</h2>
          <img
            src={
              avatarPreview ||
              toPublicUrl(avatarUrl) ||
              "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=300&auto=format&fit=crop&q=80"
            }
            alt="Student profile"
        ...
        <form className={styles.card} onSubmit={onPasswordUpdate}>
          <h2 className={styles.cardTitle}>Change Password</h2>
          <p className={styles.helper}>Use a strong password with letters, symbols and numbers.</p>
